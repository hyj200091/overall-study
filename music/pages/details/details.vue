<template>
	...
	<view style="height: 100vh;" :class="nightStatus ? 'nightTheme': ''">
		...
		<view class="flex align-center justify-center" style="height: 420rpx;">
			<image src="https://soft1851.oss-cn-beijing.aliyuncs.com/markdown/20201112145054.png" lazy-load="widthFix" style="border-radius: 35rpx;
			box-shadow: 0 2rpx 6rpx 0;"></image>
		</view>
		
		<!-- 进度部分 -->
		<view class="flex align-center justify-center font mt-5" style="color: #7a8388;height: 65rpx;">
			<!-- 总时长 -->
